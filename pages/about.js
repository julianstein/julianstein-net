    ...
    <Layout>
      ...
      <div className=" flex">
        <div className="text-lg md:text-xl w-auto flex-shrink mx-3 xl:mr-64 xl:max-w-xl md:max-w-md lg:max-w-lg sm:max-w-sm max-w-sm text-left mt-0 mb-8 md:mb-0 md:mt-20 md:ml-8 xl:mr-20 md:mr-10">
          ...
          <br />
          <p className="">
            MFA from the University of California Los Angeles in Design Media Arts, BFA from
            Concordia University in Electroacoustic Studies, co-creator of the Montreal Sound Map.
          </p>
        </div>
      </div>
    </Layout>
